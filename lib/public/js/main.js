...
$('.typeahead').typeahead(null, {
  ...
  templates: {
    suggestion: Handlebars.compile([
      '<p class="repo-language">{{value}}</p>',
      '<p class="repo-name">{{year}}</p>',
      '<p class="repo-description">{{size}}</p>'
    ].join(''))
  }
});*/
...
/*
Handlebars.compile('<p><strong>{{value}}</strong> ({{year}}) <span class="label label-elegant" title="Size">x{{size}}</span></p>')
*/
